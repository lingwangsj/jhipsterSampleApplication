...
@Injectable()
export class NetworkMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.networkModalRef(component, new NetworkMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    networkModalRef(component: Component, network: NetworkMySuffix): NgbModalRef {
