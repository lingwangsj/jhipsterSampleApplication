...
describe('Service Tests', () => {
    ...
    describe('NetworkMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(NetworkMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/networks';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return NetworkMySuffix', () => {

                let entity: NetworkMySuffix;
                service.find(123).subscribe((_entity: NetworkMySuffix) => {
                    entity = _entity;
                });
