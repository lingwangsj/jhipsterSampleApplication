...
describe('Service Tests', () => {
    ...
    describe('TenantMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TenantMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return TenantMySuffix', () => {

                let entity: TenantMySuffix;
                service.find(123).subscribe((_entity: TenantMySuffix) => {
                    entity = _entity;
                });
